...
type TleEntity struct {
	name    string
	client  *core.SatelliteTleDataSDK
...
func NewTleEntity(client *core.SatelliteTleDataSDK, entopts map[string]any) *TleEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TleEntity) GetName() string { return e.name }
...
func (e *TleEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TleEntity) Deleted() bool {
	return e.deleted
}


func (e *TleEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTleEntity(e.client, opts)
}

func (e *TleEntity) Data(args ...any) any {
...
func (e *TleEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Tle; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TleEntity) DataTyped(data ...Tle) Tle {
	if len(data) > 0 {
		return typedFrom[Tle](e.Data(asMap(data[0])))
	}
	return typedFrom[Tle](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Tle (all fields
// optional at the wire level).
func (e *TleEntity) MatchTyped(match ...Tle) Tle {
	if len(match) > 0 {
		return typedFrom[Tle](e.Match(asMap(match[0])))
	}
	return typedFrom[Tle](e.Match())
}
...
func (e *TleEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TleEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TleLoadMatch and returns an Tle. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *TleEntity) LoadTyped(reqmatch TleLoadMatch, ctrl map[string]any) (Tle, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Tle{}, err
	}
	return typedFrom[Tle](res), nil
}




func (e *TleEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// TleListMatch and returns []Tle. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *TleEntity) ListTyped(reqmatch TleListMatch, ctrl map[string]any) ([]Tle, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Tle](res), nil
}



func (e *TleEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TleEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TleEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TleEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
