...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.SATELLITETLEDATA_TEST_LIVE ||
    'TRUE' === process.env.SATELLITETLEDATA_TEST_OVERRIDE
  ) {
  ...
  m.SATELLITETLEDATA_TEST_EXPLAIN = process.env.SATELLITETLEDATA_TEST_EXPLAIN || m.SATELLITETLEDATA_TEST_EXPLAIN
