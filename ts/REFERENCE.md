# SatelliteTleData TypeScript SDK Reference

Complete API reference for the SatelliteTleData TypeScript SDK.
...
```ts
new SatelliteTleDataSDK(options?: object)
```
...
#### `SatelliteTleDataSDK.test(testopts?, sdkopts?)`
...
**Returns:** `SatelliteTleDataSDK` instance in test mode.
...
Create a new `Tle` entity instance.
...
Alias for `SatelliteTleDataSDK.test()`.
...
| `satelliteId` | `number` | Yes | NORAD catalog ID of the satellite |
...
Return the parent `SatelliteTleDataSDK` instance.
