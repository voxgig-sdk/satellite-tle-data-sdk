...
function envOverride(m) {
    if ('TRUE' === process.env.SATELLITE_TLE_DATA_TEST_LIVE ||
        'TRUE' === process.env.SATELLITE_TLE_DATA_TEST_OVERRIDE) {
    ...
    m.SATELLITE_TLE_DATA_TEST_EXPLAIN = process.env.SATELLITE_TLE_DATA_TEST_EXPLAIN || m.SATELLITE_TLE_DATA_TEST_EXPLAIN;
    return m;
}
