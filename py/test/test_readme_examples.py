# SatelliteTleData SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions SatelliteTleDataSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both SatelliteTleDataSDK(...) and SatelliteTleDataSDK.test(...) become
#      SatelliteTleDataSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "satellitetledata_sdk"
_SDK_CLASS = "SatelliteTleDataSDK"
