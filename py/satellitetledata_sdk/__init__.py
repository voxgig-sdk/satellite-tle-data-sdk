...
from satellitetledata_sdk.utility import register

# Load features
from satellitetledata_sdk.feature.base_feature import SatelliteTleDataBaseFeature
from satellitetledata_sdk.features import _has_feature, _make_feature
...
class SatelliteTleDataSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = SatelliteTleDataUtility()
    ...
    def get_utility(self):
        return SatelliteTleDataUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("SatelliteTleDataSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Tle(self, data=None) -> "TleEntity":
        ...
        from satellitetledata_sdk.entity.tle_entity import TleEntity
