...
from satellitetledata_sdk.core.control import SatelliteTleDataControl
...
from satellitetledata_sdk.core.helpers import get_ctx_prop, to_map
...
class SatelliteTleDataContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = SatelliteTleDataControl()
        ...
        if isinstance(sp, SatelliteTleDataSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, SatelliteTleDataResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, SatelliteTleDataResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return SatelliteTleDataOperation({})
    ...
    def make_error(self, code, msg):
        return SatelliteTleDataError(code, msg, self)
