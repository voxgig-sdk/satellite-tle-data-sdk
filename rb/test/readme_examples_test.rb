...
#      offline in seeded test mode (SatelliteTleDataSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "SatelliteTleData_sdk.rb")
  SDK_CLASS = "SatelliteTleDataSDK"
