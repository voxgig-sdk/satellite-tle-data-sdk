...
type Args struct {
	Entity string         `json:"entity" jsonschema:"tle"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.SatelliteTleDataSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "satellite-tle-data_list",
		Description: "List records from SatelliteTleData. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "satellite-tle-data_load",
		Description: "Load a single record from SatelliteTleData. " +
...
func runOp(client *sdk.SatelliteTleDataSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.SatelliteTleDataSDK, name string) (sdk.SatelliteTleDataEntity, error) {
	switch strings.ToLower(name) {
	case "tle":
		return client.Tle(nil), nil
