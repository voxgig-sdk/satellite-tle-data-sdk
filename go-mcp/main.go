// Command SatelliteTleData-mcp is an MCP server exposing the SatelliteTleData
// SDK as MCP tools.
//
// Two tools are registered:
//
//	SatelliteTleData_list  — list records of an entity
//	SatelliteTleData_load  — load a single record of an entity
//
