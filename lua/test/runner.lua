...
function runner.env_override(m)
  local live = runner.getenv("SATELLITETLEDATA_TEST_LIVE")
  local override = runner.getenv("SATELLITETLEDATA_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("SATELLITETLEDATA_TEST_EXPLAIN")
