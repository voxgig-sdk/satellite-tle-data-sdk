# SatelliteTleData PHP SDK



The PHP SDK for the SatelliteTleData API — an entity-oriented client using PHP conventions.
...
$tle = $client->Tle()->list();
print_r(array_map(fn($item) => $item->data_get(), $tle));
```
...
```
php/
├── satellitetledata_sdk.php          -- Main SDK class
...
The main class (`satellitetledata_sdk.php`) exports the SDK class
