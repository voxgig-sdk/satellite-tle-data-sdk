...
// SatelliteTleData SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class SatelliteTleDataTransformResponse
{
    public static function call(SatelliteTleDataContext $ctx): mixed
    {
        ...
        $transform = SatelliteTleDataHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
