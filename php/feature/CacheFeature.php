...
// SatelliteTleData SDK cache feature
...
class SatelliteTleDataCacheFeature extends SatelliteTleDataBaseFeature
{
    ...
    private function _through(SatelliteTleDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
