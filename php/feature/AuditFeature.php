...
// SatelliteTleData SDK audit feature
...
class SatelliteTleDataAuditFeature extends SatelliteTleDataBaseFeature
{
    ...
    private function _emit(SatelliteTleDataContext $ctx, string $outcome): void
    {
