...
// SatelliteTleData SDK telemetry feature
...
class SatelliteTleDataTelemetryFeature extends SatelliteTleDataBaseFeature
{
    ...
    private function _close(SatelliteTleDataContext $ctx, bool $ok): void
    {
