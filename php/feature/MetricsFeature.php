...
// SatelliteTleData SDK metrics feature
...
class SatelliteTleDataMetricsFeature extends SatelliteTleDataBaseFeature
{
    ...
    private function _record(SatelliteTleDataContext $ctx, bool $ok): void
    {
