...
// SatelliteTleData SDK timeout feature
...
class SatelliteTleDataTimeoutFeature extends SatelliteTleDataBaseFeature
{
    ...
    private function _with_timeout(SatelliteTleDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(SatelliteTleDataContext $_ctx, float $ms): void
    {
        $client = $this->client;
