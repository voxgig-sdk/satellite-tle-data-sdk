...
// SatelliteTleData SDK rbac feature
...
class SatelliteTleDataRbacFeature extends SatelliteTleDataBaseFeature
{
    ...
    private function _required(SatelliteTleDataContext $ctx): ?string
    {
    ...
    private function _reject(SatelliteTleDataContext $ctx, string $required): void
    {
    ...
    private function _track(SatelliteTleDataContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
