...
// SatelliteTleData SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (SatelliteTleDataSDK::test)
...
{
    private const SDK_CLASS = 'SatelliteTleDataSDK';
    ...
    private const SDK_BASE = 'satellitetledata_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../satellitetledata_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
