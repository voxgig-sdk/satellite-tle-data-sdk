...
// SatelliteTleData SDK utility type

class SatelliteTleDataUtility
{
    ...
    public static function copy(SatelliteTleDataUtility $src): SatelliteTleDataUtility
    {
        $u = new SatelliteTleDataUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
