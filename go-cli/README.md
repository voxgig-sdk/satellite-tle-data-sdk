...
AQL-driven CLI and REPL for the SatelliteTleData SDK. Positional arguments are
...
```sh
go build -o satellite-tle-data-cli ./...
```
...
./satellite-tle-data-cli load 1 tle
./satellite-tle-data-cli load '{id:1}' tle
