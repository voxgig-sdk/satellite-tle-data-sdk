...
func registerSDKWords(r *eng.Registry, client *sdk.SatelliteTleDataSDK) {
...
func runOp(client *sdk.SatelliteTleDataSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
