...
// SatelliteTleData SDK proxy feature
...
class SatelliteTleDataProxyFeature extends SatelliteTleDataBaseFeature
{
    ...
    public function init(SatelliteTleDataContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (SatelliteTleDataContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
