...
// SatelliteTleData SDK netsim feature
...
class SatelliteTleDataNetsimFeature extends SatelliteTleDataBaseFeature
{
    ...
    private function _simulate(SatelliteTleDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(SatelliteTleDataContext $ctx, array $applied): void
    {
        $client = $this->client;
