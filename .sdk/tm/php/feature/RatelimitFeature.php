...
// SatelliteTleData SDK ratelimit feature
...
class SatelliteTleDataRatelimitFeature extends SatelliteTleDataBaseFeature
{
    ...
    private function _acquire(SatelliteTleDataContext $ctx): void
    {
    ...
    private function _track(SatelliteTleDataContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
