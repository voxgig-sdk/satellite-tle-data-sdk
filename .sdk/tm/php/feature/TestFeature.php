...
// SatelliteTleData SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class SatelliteTleDataTestFeature extends SatelliteTleDataBaseFeature
{
    ...
    public function init(SatelliteTleDataContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (SatelliteTleDataContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = SatelliteTleDataParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (SatelliteTleDataContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(SatelliteTleDataContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = SatelliteTleDataParam::call($ctx, $k);
