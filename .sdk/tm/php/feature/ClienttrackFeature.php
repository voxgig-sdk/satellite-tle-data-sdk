...
// SatelliteTleData SDK clienttrack feature
...
class SatelliteTleDataClienttrackFeature extends SatelliteTleDataBaseFeature
{
    ...
    public function PostConstruct(SatelliteTleDataContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'SatelliteTleData-SDK';
