...
// SatelliteTleData SDK utility: fetcher

class SatelliteTleDataFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; SatelliteTleDataSDK/1.0)';
    ...
    public static function call(SatelliteTleDataContext $ctx, string $fullurl, array $fetchdef): array
    {
