...
// SatelliteTleData SDK utility: make_options

class SatelliteTleDataMakeOptions
{
    ...
    public static function call(SatelliteTleDataContext $ctx): array
    {
        ...
        //
        // `SatelliteTleDataSchema::optspec()` is built from the model:
        ...
        $optspec = SatelliteTleDataSchema::optspec();
