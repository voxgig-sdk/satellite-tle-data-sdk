...
// SatelliteTleData SDK utility: graphql
//
...
class SatelliteTleDataGraphql
{
    ...
    // equivalent.
    public static function body(SatelliteTleDataContext $ctx): mixed
    {
    ...
    public static function errors(SatelliteTleDataContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
