...
// SatelliteTleData SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = SatelliteTleDataOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(SatelliteTleDataOmni::structfix($now, Struct::undef()))
                        !== json_encode(SatelliteTleDataOmni::structfix($val, Struct::undef()))) {
