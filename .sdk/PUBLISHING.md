...
|---|---|---|
| `ts/` | @voxgig-sdk/satellite-tle-data-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/satellite-tle-data-sdk \
      --repository voxgig-sdk/satellite-tle-data-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/satellite-tle-data-sdk` shows it, and
`npm trust revoke @voxgig-sdk/satellite-tle-data-sdk --id=<id>` removes it.
