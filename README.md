...
Learn more about Satellite TLE Data at [tle.ivanstanojevic.me](https://tle.ivanstanojevic.me).
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/satellite-tle-data-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/satellite-tle-data-sdk/tags) |
| Python | `voxgig-sdk-satellite-tle-data` | publish pending — [install from git tag](https://github.com/voxgig-sdk/satellite-tle-data-sdk/tags) |
| PHP | `voxgig-sdk/satellite-tle-data` | publish pending — [install from git tag](https://github.com/voxgig-sdk/satellite-tle-data-sdk/tags) |
| Golang | `github.com/voxgig-sdk/satellite-tle-data-sdk/go` | `go get github.com/voxgig-sdk/satellite-tle-data-sdk/go@latest` |
| Ruby | `voxgig-sdk-satellite-tle-data` | publish pending — [install from git tag](https://github.com/voxgig-sdk/satellite-tle-data-sdk/tags) |
| Lua | `voxgig-sdk-satellite-tle-data` | publish pending — [install from git tag](https://github.com/voxgig-sdk/satellite-tle-data-sdk/tags) |
| Go CLI | `github.com/voxgig-sdk/satellite-tle-data-sdk/go-cli` | `go install github.com/voxgig-sdk/satellite-tle-data-sdk/go-cli/cmd/satellite-tle-data@latest` |
| Go MCP server | `github.com/voxgig-sdk/satellite-tle-data-sdk/go-mcp` | `go get github.com/voxgig-sdk/satellite-tle-data-sdk/go-mcp@latest` |
...
$tles = $client->Tle()->list();
print_r(array_map(fn($item) => $item->data_get(), $tles));
